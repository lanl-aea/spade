...
class SpadeObject {
    public:
        ...
        */
        ...
        //! Write field bulk data in the extract format to an HDF5 file
        /*!
          Write field bulk data into an HDF5 file in the extract format
          \param h5_file Open h5_file object for writing
          \param group_name Name of the group where data is to be written
          \param field_bulk_data Data to be written
          \param complex_data Boolean indicating if the data is complex
        ...
        */
        ...
        /*!
          ...
          \param float_array A pointer to the array of arrays of floats that should be written in the new dataset
        */
        void write_float_3D_array(const H5::Group &group, const string &dataset_name, const int &aisle_size, const int &row_size, const int &column_size, float *float_array);
        ...
        */
        ...
        /*!
          ...
          \param aisle_size Integer indicating the row dimension
          \param row_size Integer indicating the row dimension
          \param column_size Integer indicating the column dimension
          \param double_array A pointer to the array of arrays of arrays of doubles that should be written in the new dataset
        */
        void write_double_3D_array(const H5::Group &group, const string &dataset_name, const int &aisle_size, const int &row_size, const int &column_size, double *double_array);
